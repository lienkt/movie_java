...
public class MovieController {
	...
	public ResponseEntity<List<Movie>> search(@PathVariable("id") String id) throws DataAccessException {
	...
	Movie update(@RequestBody Movie updateMovie, @PathVariable String id) throws DataAccessException {
